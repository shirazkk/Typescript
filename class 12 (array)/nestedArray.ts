...
const fruits=["Peach","Cheeku",["Mango","apple","Banana"]]//we declare array in array which called nested array
...
const elements=[1,2,3,4,5,6,["a","b"]]
console.log(elements[6][1]);//6 index pe "a" araha ha or usme 1 pe b arah ha.
